...
export class ChatServiceClient {
  ...
  ): Promise<chat_pb.SendMessageResponse>;
  ...
  sendMessage(
    ...
    callback: (
      ...
      response: chat_pb.SendMessageResponse
    ) => void
  ): grpcWeb.ClientReadableStream<chat_pb.SendMessageResponse>;
  ...
  ): grpcWeb.ClientReadableStream<chat_pb.OnMessageResponse> {
    return this.client_.serverStreaming(
      this.hostname_ + "/chat.ChatService/onMessage",
      request,
      metadata || {},
